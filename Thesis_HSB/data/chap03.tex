...
\begin{figure}[h] % use float package if you want it here
  \centering
  \includegraphics[width=12cm]{3Dconstr_get_picture.png}
  \caption{堆体图像采集示意图}
...
\begin{figure}[H] % use float package if you want it here
  \centering
  \includegraphics[height=6cm]{3Dconstr_Fast.png}
  \caption{FAST特征点}
...
\begin{figure}[H]
    \centering
      ...
      \includegraphics[width=6cm]{3Dconstr_a.png}}
    ...
    \vskip0.5cm
      ...
      \includegraphics[width=12cm]{3Dconstr_match.png}}
    \vskip0.5cm
...
\begin{figure}[H] % use float package if you want it here
  \centering
  \includegraphics[width=12cm]{3dconstr_sparse.png}
  \caption{堆体稀疏重建示意图}
