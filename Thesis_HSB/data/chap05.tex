...
\begin{table}[h]
  ...
  \begin{tabular}{@{}lccc@{}}
  \toprule
  \textbf{序号} & \textbf{1} & \textbf{2} & \textbf{3} \\
  \midrule
  图像集数量 &	186&	202&	197\\
  图像分辨率 &	960*455&	960*455&	960*45\\
  场景预览   
  & \includegraphics[width=7.5cm, height=5cm]{getVolume_3dconstr_1.png}
  & \includegraphics[width=7.5cm, height=5cm]{getVolume_3dconstr_1.png}
  & \includegraphics[width=7.5cm, height=5cm]{getVolume_3dconstr_1.png}    \\
  稀疏点云    
  & \includegraphics[width=7.5cm, height=5cm]{getVolume_3dconstr_1.png}
  ...
  & \includegraphics[width=7.5cm, height=5cm]{getVolume_3dconstr_1.png}    \\
  尺度$K$&	2.4&	3.9&	4.6\\
  平面方程$\pi$& $2x+3y=0$&2x+3y=0&2x+3y=0\\
  稠密点云    
  & \includegraphics[width=7.5cm, height=5cm]{getVolume_3dconstr_1.png}
  & \includegraphics[width=7.5cm, height=5cm]{getVolume_3dconstr_1.png}
  & \includegraphics[width=7.5cm, height=5cm]{getVolume_3dconstr_1.png}    \\
  计算耗时\\(s)&	634&	585&	565\\
  计算结果\\($cm^3$)&	13149&	12879&	12830\\
  误差&	1.1$\%$&	0.9$\%$&	1.3$\%$\\
  \bottomrule
  \end{tabular}
      }
